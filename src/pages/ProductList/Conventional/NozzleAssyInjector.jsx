...
const NozzleAssyInjectorList = () => {
    const products = [
        {
            name: 'Nozzle Assy Injector Mitsubishi Canter PS125 PS136 HD HDX 4D34T ME215104',
        },
    ];
    ...
    return (
        <div className='mx-auto sm:max-w-full md:max-w-full lg:max-full md:px-0 md:py-0 lg:px-0 lg:py-0 bg-gradient-to-r from-gray-100 to-gray-300 '>
            <Helmet>
                <title>
                    Nozzle Assy Injector Product List | Itech Persada Nusantara
                </title>
                <meta
                    name='description'
                ...
                <meta
                    name='keywords'
                    content='Nozzle Assy Injector, Nozzle Assy Injector Nozzle, Itech Persada Nusantara'
                />
            </Helmet>
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724657138/cp-itech/categories/nozzle/nozzle_assy_DSC_0510-removebg-preview_nfcigk_tgta6r.png'
                        alt='itech product'
                    />
                </div>
...
export default NozzleAssyInjectorList;
