...
const ThreePinInjectorList = () => {
    const products = [
        {
            name: 'Tool Open Injector Nozzle Nosel Denso 3 Pins - Three Pin Wrench SST Repair Tools Denso',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661272/cp-itech/categories/tools/TOOL_INJECTOR_DENSO_3_PINS_DSC_0815_maqcxw_u89aeb.png'
                        alt='itech product'
                    />
                </div>
...
export default ThreePinInjectorList;
