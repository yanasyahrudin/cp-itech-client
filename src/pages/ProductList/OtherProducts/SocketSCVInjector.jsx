...
const SocketSCVInjectorList = () => {
    const products = [
        {
            name: 'Socket SCV Denso Injector Denso Dmax (Rp.30.000)',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724666211/cp-itech/categories/socket/Soket_SCV_Denso_Injector_Denso_Dmax-removebg-preview_af8myr.png'
                        alt='itech product'
                    />
                </div>
...
export default SocketSCVInjectorList;
