...
import { IoChatbox, IoArrowBackCircle } from 'react-icons/io5';
import products from '../../../dataProducts/OtherProducts/coverL';
import {
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724900197/cp-itech/categories/coverInjector/cover_injector_L_bk518v.png'
                        alt='itech product'
                    />
                </div>
