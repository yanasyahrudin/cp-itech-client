...
const ToolsCat = () => {
    const products = [
        {
            name: 'Tool Injector CAT 320D - SST Tools Repair Kit Injector',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661271/cp-itech/categories/tools/TOOLS_CAT_DSC_0510_copy_np60qw_t7aroq.png'
                        alt='itech product'
                    />
                </div>
