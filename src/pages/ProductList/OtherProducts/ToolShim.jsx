...
const ToolShimList = () => {
    const products = [
        {
            name: 'Injector Shim Thinning Tool E1024072 Shim Polish Injector Nozzle Tool',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661273/cp-itech/categories/tools/Tool_Shim_E1024072_Itech_Rp.500.000__DSC_0140_copy_ezotmx_msak63.png'
                        alt='itech product'
                    />
                </div>
