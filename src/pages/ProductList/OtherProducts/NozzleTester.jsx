...
import products from '../../../dataProducts/OtherProducts/nozzleTester';
import {
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724727823/cp-itech/categories/tools/Tester_Nozzle_atjdty_g82g4k.png'
                        alt='itech product'
                    />
                </div>
...
export default NozzleTesterList;
