...
const FilterWrenchToolList = () => {
    const products = [
        {
            name: 'Oil Filter Dismantling Tool - Removal Fuel Filter Injector Tool',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661272/cp-itech/categories/tools/TOOL_PEMBUKA_FILTER_DENSO_DSC_0003-removebg-preview_k0jsku_xxpdmb.png'
                        alt='itech product'
                    />
                </div>
...
export default FilterWrenchToolList;
