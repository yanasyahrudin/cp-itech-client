...
const PressureGaugeList = () => {
    const products = [
        {
            name: 'Pressure Gauge Nozzle Tester S60H Pressure Metering 60 MPA 8000 PSI',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661273/cp-itech/categories/tools/Pressure_Gauge_Itech_DSC_0574b_copy_ttwser_moncb2.png'
                        alt='itech product'
                    />
                </div>
...
export default PressureGaugeList;
