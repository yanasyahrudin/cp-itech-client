...
import products from '../../../dataProducts/OtherProducts/sensorCommonRail';
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724898355/cp-itech/categories/sensor/rail_pressure_sensor_DSC_0650-removebg-preview_lunm6u.png'
                        alt='itech product'
                    />
                </div>
...
export default SensorCommonRailList;
