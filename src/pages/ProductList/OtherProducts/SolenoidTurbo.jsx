...
import products from '../../../dataProducts/OtherProducts/solenoidTurbo'
import {
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724664886/cp-itech/categories/turboCharger/Actuator_Vacum_turbo_Ford_XLT_XLS_IMG_20230824_142812-removebg-preview_pmh3wg.png'
                        alt='itech product'
                    />
                </div>
...
export default SolenoidTurboList;
