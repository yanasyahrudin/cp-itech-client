...
const PinToolList = () => {
    const products = [
        {
            name: 'Denso 3 Pin Injector Nozzle Open Pin Tool - Three Pin Set Denso SST Repair Tool',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724661273/cp-itech/categories/tools/pin_tool_DSC_1437-removebg-preview_bfhsgr_ib7jkw.png'
                        alt='itech product'
                    />
                </div>
