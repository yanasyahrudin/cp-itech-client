...
const HexKeyList = () => {
    const products = [
        {
            name: 'Screwdriver Bit Shock Wrench Nut Bolt Nutdriver Hexagonal CRV 3-14mm - 3.5mm',
        },
    ];
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1724727991/cp-itech/categories/tools/KUNCI%20HEX%20KEY%20no.0512%203.5MM_DSC_0562-removebg-preview_dlsple.png'
                        alt='itech product'
                    />
                </div>
