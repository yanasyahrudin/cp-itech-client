...
const RotorSetFPList = () => {
    const products = [
        {
            name: 'Rotor Set Feed Pump 294180-0090 /0080 HP3 Toyota Hilux 2.5 2500c - 8mm dan 10mm Bospom Triton Hilux Innova Pajero',
        },
    ];
    ...
    return (
        <div className='mx-auto sm:max-w-full md:max-w-full lg:max-full md:px-0 md:py-0 lg:px-0 lg:py-0 bg-gradient-to-r from-gray-100 to-gray-300 '>
            <Helmet>
                <title>
                    Rotor Set Feed Pump Product List | Itech Persada Nusantara
                </title>
                <meta
                    name='description'
                ...
                <meta
                    name='keywords'
                    content='Rotor Set Feed Pump, Rotor Set Feed Pump Supply Pump, Itech Persada Nusantara'
                />
            </Helmet>
            ...
            <div className='relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-0 xl:max-w-6xl p-5 lg:p-10 md:p-10'>
                <div className='w-full h-64 lg:w-1/2 lg:h-auto md:h-auto '>
                    <img
                        ...
                        src='https://res.cloudinary.com/dcbryptkx/image/upload/v1725093476/cp-itech/categories/supplyPump/DSC_0122b-removebg-preview_x9f6dm_hvocpc.png'
                        alt='itech product'
                    />
                </div>
